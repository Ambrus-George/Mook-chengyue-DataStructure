...
3. [File Transfer](FileTransfer.cpp)
    ...
    ```
4. [Huffman Codes](HuffmanCodes.cpp) + [我的错误版本](HuffmanCodes_AmbGeo.cpp)
    > 写得太复杂了，最后修改下来，还有有一个测试点没有通过，最大N&M，不明白为啥，使用AI修改的代码很简洁，后面再改改看，完善完善     

## 第六周
1. [列出连通集](ListGroup.cpp)
...
3. [六度空间](SixDegreesSpace.cpp)
   ...
   ```
## 第七周
1. [哈利*波特的考试](HerryPotterExam.cpp)
...
2. [Saving James Bond - Hard Version(写的第一版，无法通过全部测试点)](SavingJamesAgain.cpp)
   </br>
   [按照文章作者的思路，重新写的程序，通过全部测试点](SavingJamesAgain1.cpp)
